...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Dar pais por atleta");
	}
	private void paisPorAtleta(String atleta) 
	{
		List<Atleta> atletas = calculadora.atletas;
		String a = "No se encontr� el atleta";
		
		for (Atleta atletai : atletas) {
			
			if (atletai.darNombre().toLowerCase().equals(atleta.toLowerCase())) {
				a = atletai.darPais().darNombre();
				break;
			}
